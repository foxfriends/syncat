...
pub enum Lang {
    ...
    #[cfg(any(lang_all, lang_elm))]                Elm,
    #[cfg(any(lang_all, lang_embedded_template))]  EmbeddedTemplate,
    #[cfg(any(lang_all, lang_eno))]                Eno,
    ...
    #[cfg(any(lang_all, lang_markdown))]           Markdown,
    ...
    #[cfg(any(lang_all, lang_syncat_systemrdl))]   SystemRdl,
    #[cfg(any(lang_all, lang_latex))]              Tex,
    #[cfg(any(lang_all, lang_toml))]               Toml,
...
impl std::str::FromStr for Lang {
    ...
    fn from_str(name: &str) -> Result<Lang, Self::Err> {
        ...
        match name.trim().to_lowercase().as_str() {
            ...
            #[cfg(any(lang_all, lang_elm))]                "elm"                               => Ok(Elm),
            #[cfg(any(lang_all, lang_embedded_template))]  "erb" | "ejs"                       => Ok(EmbeddedTemplate),
            #[cfg(any(lang_all, lang_eno))]                "eno"                               => Ok(Eno),
            ...
            #[cfg(any(lang_all, lang_markdown))]           "md" | "markdown"                   => Ok(Markdown),
            #[cfg(any(lang_all, lang_ocaml))]              "sml" | "ml" | "mli" | "ocaml"      => Ok(OCaml),
            ...
            #[cfg(any(lang_all, lang_systemrdl))]          "rdl" | "systemrdl"                 => Ok(SystemRdl),
            #[cfg(any(lang_all, lang_latex))]              "tex" | "latex" | "xetex"           => Ok(Tex),
            #[cfg(any(lang_all, lang_toml))]               "toml"                              => Ok(Toml),
...
impl Lang {
    pub fn parser(&self) -> Language {
        ...
        unsafe {
            match *self {
                ...
                #[cfg(any(lang_all, lang_elm))]                Elm              => tree_sitter_elm(),
                #[cfg(any(lang_all, lang_embedded_template))]  EmbeddedTemplate => tree_sitter_embedded_template(),
                #[cfg(any(lang_all, lang_eno))]                Eno              => tree_sitter_eno(),
                ...
                #[cfg(any(lang_all, lang_markdown))]           Markdown         => tree_sitter_markdown(),
                ...
                #[cfg(any(lang_all, lang_systemrdl))]          SystemRdl        => tree_sitter_systemrdl(),
                #[cfg(any(lang_all, lang_latex))]              Tex              => tree_sitter_latex(),
                #[cfg(any(lang_all, lang_test))]               TreeSitterCorpus => tree_sitter_test(),
                #[cfg(any(lang_all, lang_toml))]               Toml             => tree_sitter_toml(),
                ...
                #[cfg(any(lang_all, lang_yaml))]               Yaml             => tree_sitter_yaml(),
            }
        }
    }
    ...
    fn ext(&self) -> &'static str {
        ...
        match *self {
            ...
            #[cfg(any(lang_all, lang_elm))]                Elm              => "elm",
            #[cfg(any(lang_all, lang_embedded_template))]  EmbeddedTemplate => "template",
            #[cfg(any(lang_all, lang_eno))]                Eno              => "eno",
            ...
            #[cfg(any(lang_all, lang_markdown))]           Markdown         => "md",
