...
enum {
  ...
  sym__simple_terminal = 46,
  sym__complex_terminal = 47,
  sym__simple_node = 48,
  sym__complex_node = 49,
  sym_direct_child = 50,
  sym_direct_terminal = 51,
  sym_branch_check = 52,
  sym_node_kind = 53,
  sym_token = 54,
  sym__style_block = 55,
...
static uint16_t ts_parse_table[STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym__terminal_selector] = STATE(7),
    ...
    [sym__simple_terminal] = STATE(7),
    [sym__complex_terminal] = STATE(7),
  ...
  [2] = {
    ...
    [sym__unquoted_string] = ACTIONS(17),
    [sym_comment] = ACTIONS(3),
  ...
  [13] = {
    [sym__unquoted_string] = ACTIONS(47),
    [anon_sym_GT] = ACTIONS(47),
    [sym_comment] = ACTIONS(3),
    [sym__quoted_string] = ACTIONS(47),
  ...
  [17] = {
    ...
    [sym_direct_child] = STATE(12),
    [sym_direct_terminal] = STATE(7),
    [sym__unquoted_string] = ACTIONS(59),
  ...
  [18] = {
    ...
    [sym_style] = STATE(29),
    [sym__boolean_style] = STATE(30),
    [sym__color_style] = STATE(31),
    ...
    [sym__string_style] = ACTIONS(77),
  },
  [19] = {
    [sym__style_list] = STATE(32),
    [sym_style] = STATE(33),
    [sym__boolean_style] = STATE(30),
    [sym__color_style] = STATE(31),
    [anon_sym_strikethrough] = ACTIONS(73),
  ...
  [20] = {
    [sym__unquoted_string] = ACTIONS(79),
  ...
  [23] = {
    [sym__unquoted_string] = ACTIONS(87),
  ...
  [24] = {
    ...
    [anon_sym_LBRACE_PIPE] = ACTIONS(91),
    [sym_comment] = ACTIONS(3),
  },
  [25] = {
  ...
  [33] = {
    ...
    [sym_comment] = ACTIONS(3),
    [anon_sym_PIPE_RBRACE] = ACTIONS(103),
  },
  [34] = {
  ...
  [35] = {
    [sym__unquoted_string] = ACTIONS(115),
    [anon_sym_GT] = ACTIONS(115),
    [ts_builtin_sym_end] = ACTIONS(115),
    [sym_comment] = ACTIONS(3),
    [sym__quoted_string] = ACTIONS(115),
  ...
  [38] = {
    ...
    [anon_sym_white] = ACTIONS(121),
    [anon_sym_red] = ACTIONS(121),
    [anon_sym_black] = ACTIONS(121),
    [anon_sym_green] = ACTIONS(121),
    [anon_sym_cyan] = ACTIONS(121),
    [sym_comment] = ACTIONS(3),
    [anon_sym_blue] = ACTIONS(121),
    [anon_sym_purple] = ACTIONS(121),
    [sym__color_index] = ACTIONS(121),
    [anon_sym_yellow] = ACTIONS(121),
    [sym__rgb_color] = ACTIONS(121),
  },
  [39] = {
    [sym__unquoted_string] = ACTIONS(123),
    [anon_sym_GT] = ACTIONS(123),
    [ts_builtin_sym_end] = ACTIONS(123),
    [sym_comment] = ACTIONS(3),
    [sym__quoted_string] = ACTIONS(123),
  ...
  [41] = {
    ...
    [anon_sym_PIPE_RBRACE] = ACTIONS(125),
  },
  [42] = {
    [sym_comment] = ACTIONS(3),
    [anon_sym_SEMI] = ACTIONS(127),
    [anon_sym_RBRACE] = ACTIONS(127),
    [anon_sym_PIPE_RBRACE] = ACTIONS(127),
  },
  [43] = {
    [anon_sym_PIPE_RBRACE] = ACTIONS(129),
  ...
  [45] = {
    ...
    [anon_sym_PIPE_RBRACE] = ACTIONS(133),
  },
};
...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [15] = {.count = 1, .reusable = false}, REDUCE(sym_node_kind, 1),
  [17] = {.count = 1, .reusable = true}, REDUCE(sym_node_kind, 1),
  [19] = {.count = 1, .reusable = false}, REDUCE(sym_token, 1),
  [21] = {.count = 1, .reusable = true}, REDUCE(sym_token, 1),
  [23] = {.count = 1, .reusable = false}, REDUCE(sym__selectors, 1),
  [25] = {.count = 1, .reusable = true}, REDUCE(sym__selectors, 1),
  [27] = {.count = 1, .reusable = true}, SHIFT(16),
  [29] = {.count = 1, .reusable = false}, REDUCE(sym_selector, 1),
  [31] = {.count = 1, .reusable = true}, REDUCE(sym_selector, 1),
  [33] = {.count = 1, .reusable = true}, REDUCE(sym_stylesheet, 1),
  [35] = {.count = 1, .reusable = false}, SHIFT(18),
  [37] = {.count = 1, .reusable = true}, SHIFT(19),
  [39] = {.count = 1, .reusable = false}, REDUCE(sym__simple_terminal, 1),
  [41] = {.count = 1, .reusable = true}, REDUCE(sym__simple_node, 1),
  [43] = {.count = 1, .reusable = true}, REDUCE(sym__simple_terminal, 1),
  [45] = {.count = 1, .reusable = true},  ACCEPT_INPUT(),
  [47] = {.count = 1, .reusable = true}, REDUCE(sym_direct_child, 2),
  [49] = {.count = 1, .reusable = false}, REDUCE(sym_direct_terminal, 2),
  [51] = {.count = 1, .reusable = true}, REDUCE(sym_direct_terminal, 2),
  [53] = {.count = 1, .reusable = true}, SHIFT(23),
  [55] = {.count = 1, .reusable = false}, REDUCE(sym__selectors, 2),
  [57] = {.count = 1, .reusable = true}, REDUCE(sym__selectors, 2),
  [59] = {.count = 2, .reusable = true}, REDUCE(aux_sym_stylesheet_repeat1, 2), SHIFT_REPEAT(2),
  [62] = {.count = 2, .reusable = true}, REDUCE(aux_sym_stylesheet_repeat1, 2), SHIFT_REPEAT(3),
  [65] = {.count = 1, .reusable = true}, REDUCE(aux_sym_stylesheet_repeat1, 2),
  [67] = {.count = 2, .reusable = true}, REDUCE(aux_sym_stylesheet_repeat1, 2), SHIFT_REPEAT(4),
  [70] = {.count = 2, .reusable = true}, REDUCE(aux_sym_stylesheet_repeat1, 2), SHIFT_REPEAT(5),
  ...
  [87] = {.count = 1, .reusable = true}, REDUCE(sym_branch_check, 3),
  [89] = {.count = 1, .reusable = false}, REDUCE(sym__selectors, 3),
  [91] = {.count = 1, .reusable = true}, REDUCE(sym__selectors, 3),
  [93] = {.count = 1, .reusable = true}, REDUCE(sym__boolean_style, 1),
  [95] = {.count = 1, .reusable = true}, REDUCE(sym__color_style, 1),
  [97] = {.count = 1, .reusable = true}, SHIFT(34),
  [99] = {.count = 1, .reusable = true}, SHIFT(35),
  [101] = {.count = 1, .reusable = true}, SHIFT(36),
  [103] = {.count = 1, .reusable = true}, REDUCE(sym__style_list, 1),
  ...
  [115] = {.count = 1, .reusable = true}, REDUCE(sym_styles, 3),
  [117] = {.count = 1, .reusable = true}, REDUCE(sym__style_list, 2),
  [119] = {.count = 1, .reusable = true}, SHIFT(44),
  [121] = {.count = 1, .reusable = true}, SHIFT(45),
  [123] = {.count = 1, .reusable = true}, REDUCE(sym_important_styles, 3),
  [125] = {.count = 1, .reusable = true}, REDUCE(sym__string_value, 1),
  [127] = {.count = 1, .reusable = true}, REDUCE(sym_style, 3),
  [129] = {.count = 1, .reusable = true}, REDUCE(sym__style_list, 3),
  [131] = {.count = 1, .reusable = true}, REDUCE(sym__boolean_value, 1),
  [133] = {.count = 1, .reusable = true}, REDUCE(sym__color_value, 1),
};
