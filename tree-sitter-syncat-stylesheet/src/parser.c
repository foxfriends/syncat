...
enum {
  ...
  sym__conditional_terminal = 44,
  sym__concrete_terminal = 45,
  sym__branch_check_terminal = 46,
  sym__selector_scope = 47,
  sym__selector_node = 48,
  sym__conditional_node = 49,
  sym__concrete_node = 50,
  sym_branch_check = 51,
  sym_direct_child = 52,
  sym_node_kind = 53,
  sym_token = 54,
  sym__style_block = 55,
  sym_styles = 56,
  sym_important_styles = 57,
  sym__style_list = 58,
  sym_style = 59,
  sym__color_style = 60,
  sym__color_value = 61,
  sym__color_literal = 62,
  sym__boolean_style = 63,
  sym__boolean_value = 64,
  sym__string_value = 65,
...
static const char *ts_symbol_names[] = {
  ...
  [sym__conditional_terminal] = "_conditional_terminal",
  [sym__concrete_terminal] = "_concrete_terminal",
  [sym__branch_check_terminal] = "branch_check",
  [sym__selector_scope] = "_selector_scope",
  [sym__selector_node] = "_selector_node",
  [sym__conditional_node] = "_conditional_node",
  [sym__concrete_node] = "_concrete_node",
...
static const TSSymbolMetadata ts_symbol_metadata[] = {
  ...
  [sym__conditional_terminal] = {
    .visible = false,
    .named = true,
  },
  [sym__concrete_terminal] = {
    .visible = false,
    .named = true,
  },
  [sym__branch_check_terminal] = {
    .visible = true,
    .named = true,
  },
  [sym__selector_scope] = {
...
static uint16_t ts_parse_table[STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym__conditional_node] = STATE(9),
    [sym_token] = STATE(6),
    [aux_sym_stylesheet_repeat1] = STATE(7),
    [sym_rule] = STATE(7),
    [sym__selectors] = STATE(8),
    [sym__branch_check_terminal] = STATE(6),
    [sym__selector_scope] = STATE(9),
    [sym_direct_child] = STATE(9),
    [sym_node_kind] = STATE(10),
    [sym_stylesheet] = STATE(11),
    [sym__conditional_terminal] = STATE(6),
    [sym__concrete_terminal] = STATE(6),
    [sym__concrete_node] = STATE(9),
  ...
  [9] = {
    [sym_node_kind] = STATE(10),
    [sym__terminal_selector] = STATE(18),
    [sym__selector_node] = STATE(19),
    [sym__conditional_node] = STATE(19),
    [sym_token] = STATE(18),
    [sym__conditional_terminal] = STATE(18),
    [sym__concrete_terminal] = STATE(18),
    [sym__concrete_node] = STATE(19),
    [sym_branch_check] = STATE(19),
    [sym__branch_check_terminal] = STATE(18),
    [sym_direct_child] = STATE(19),
    [sym__unquoted_string] = ACTIONS(5),
    [anon_sym_LBRACK] = ACTIONS(7),
    [sym_comment] = ACTIONS(3),
    [sym__quoted_string] = ACTIONS(11),
  ...
  [10] = {
    ...
    [sym__unquoted_string] = ACTIONS(39),
  ...
  [15] = {
    ...
    [sym_style] = STATE(27),
    [sym__boolean_style] = STATE(28),
    [sym__color_style] = STATE(29),
    [anon_sym_strikethrough] = ACTIONS(64),
    [anon_sym_bold] = ACTIONS(64),
    [anon_sym_dim] = ACTIONS(64),
    [sym_comment] = ACTIONS(3),
    [anon_sym_colour] = ACTIONS(66),
    [anon_sym_underline] = ACTIONS(64),
    [anon_sym_background_DASHcolour] = ACTIONS(66),
    [anon_sym_hidden] = ACTIONS(64),
    [anon_sym_reverse] = ACTIONS(64),
    [anon_sym_color] = ACTIONS(66),
    [anon_sym_italic] = ACTIONS(64),
    [anon_sym_blink] = ACTIONS(64),
    [anon_sym_background_DASHcolor] = ACTIONS(66),
    [sym__string_style] = ACTIONS(68),
  },
  [16] = {
  ...
  [17] = {
    [sym__unquoted_string] = ACTIONS(70),
    [anon_sym_LBRACK] = ACTIONS(70),
    [ts_builtin_sym_end] = ACTIONS(70),
    [sym_comment] = ACTIONS(3),
    [sym__quoted_string] = ACTIONS(70),
  },
  [18] = {
  ...
  [19] = {
    [sym__unquoted_string] = ACTIONS(76),
  ...
  [21] = {
    [sym_node_kind] = STATE(10),
    [sym__concrete_terminal] = STATE(32),
    [sym__concrete_node] = STATE(33),
    [sym_token] = STATE(32),
    [sym_direct_child] = STATE(33),
    [sym__unquoted_string] = ACTIONS(5),
    [sym__quoted_string] = ACTIONS(11),
    [sym_comment] = ACTIONS(3),
  },
  ...
  [30] = {
    [sym_comment] = ACTIONS(3),
    [anon_sym_PIPE_RBRACE] = ACTIONS(100),
  },
  [31] = {
    [anon_sym_SEMI] = ACTIONS(102),
    [sym_comment] = ACTIONS(3),
    [anon_sym_PIPE_RBRACE] = ACTIONS(94),
  },
  [32] = {
  ...
  [34] = {
    [sym__string_value] = STATE(42),
    [sym__unquoted_string] = ACTIONS(110),
    [sym__quoted_string] = ACTIONS(110),
    [sym_comment] = ACTIONS(3),
  },
  [35] = {
  ...
  [37] = {
    [sym__boolean_value] = STATE(42),
    [anon_sym_true] = ACTIONS(116),
    [anon_sym_false] = ACTIONS(116),
    [sym_comment] = ACTIONS(3),
  },
  [38] = {
    [sym__color_value] = STATE(42),
    [sym__color_literal] = STATE(45),
    [anon_sym_white] = ACTIONS(118),
    [anon_sym_red] = ACTIONS(118),
    [anon_sym_black] = ACTIONS(118),
    [anon_sym_green] = ACTIONS(118),
    [anon_sym_cyan] = ACTIONS(118),
    [sym_comment] = ACTIONS(3),
    [anon_sym_blue] = ACTIONS(118),
    [anon_sym_purple] = ACTIONS(118),
    [sym__color_index] = ACTIONS(118),
    [anon_sym_yellow] = ACTIONS(118),
    [sym__rgb_color] = ACTIONS(118),
  },
  [39] = {
    [sym__unquoted_string] = ACTIONS(120),
    [anon_sym_LBRACK] = ACTIONS(120),
    [ts_builtin_sym_end] = ACTIONS(120),
    [sym_comment] = ACTIONS(3),
    [sym__quoted_string] = ACTIONS(120),
  },
  [40] = {
    [sym__style_list] = STATE(43),
    [sym_style] = STATE(31),
    ...
    [anon_sym_background_DASHcolor] = ACTIONS(66),
    [sym__string_style] = ACTIONS(68),
    [anon_sym_PIPE_RBRACE] = ACTIONS(114),
    [anon_sym_bold] = ACTIONS(64),
    [anon_sym_dim] = ACTIONS(64),
    [anon_sym_colour] = ACTIONS(66),
    [anon_sym_background_DASHcolour] = ACTIONS(66),
...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [37] = {.count = 1, .reusable = false}, REDUCE(sym__concrete_terminal, 1),
  [39] = {.count = 1, .reusable = true}, REDUCE(sym__concrete_node, 1),
  [41] = {.count = 1, .reusable = true}, SHIFT(20),
  [43] = {.count = 1, .reusable = true}, REDUCE(sym__concrete_terminal, 1),
  ...
  [53] = {.count = 2, .reusable = true}, REDUCE(aux_sym_stylesheet_repeat1, 2), SHIFT_REPEAT(2),
  [56] = {.count = 2, .reusable = true}, REDUCE(aux_sym_stylesheet_repeat1, 2), SHIFT_REPEAT(3),
  [59] = {.count = 1, .reusable = true}, REDUCE(aux_sym_stylesheet_repeat1, 2),
  [61] = {.count = 2, .reusable = true}, REDUCE(aux_sym_stylesheet_repeat1, 2), SHIFT_REPEAT(4),
  [64] = {.count = 1, .reusable = true}, SHIFT(23),
  [66] = {.count = 1, .reusable = true}, SHIFT(24),
  [68] = {.count = 1, .reusable = true}, SHIFT(25),
  [70] = {.count = 1, .reusable = true}, REDUCE(sym_rule, 2),
  [72] = {.count = 1, .reusable = false}, REDUCE(sym_selector, 2),
  [74] = {.count = 1, .reusable = true}, REDUCE(sym_selector, 2),
  [76] = {.count = 1, .reusable = true}, REDUCE(sym__selector_scope, 2),
  [78] = {.count = 1, .reusable = true}, REDUCE(sym_direct_child, 2),
  [80] = {.count = 1, .reusable = false}, REDUCE(sym__selectors, 3),
  [82] = {.count = 1, .reusable = true}, REDUCE(sym__selectors, 3),
  [84] = {.count = 1, .reusable = true}, REDUCE(sym__boolean_style, 1),
  [86] = {.count = 1, .reusable = true}, REDUCE(sym__color_style, 1),
  [88] = {.count = 1, .reusable = true}, SHIFT(34),
  [90] = {.count = 1, .reusable = true}, SHIFT(35),
  [92] = {.count = 1, .reusable = true}, SHIFT(36),
  [94] = {.count = 1, .reusable = true}, REDUCE(sym__style_list, 1),
  [96] = {.count = 1, .reusable = true}, SHIFT(37),
  [98] = {.count = 1, .reusable = true}, SHIFT(38),
  [100] = {.count = 1, .reusable = true}, SHIFT(39),
  [102] = {.count = 1, .reusable = true}, SHIFT(40),
  [104] = {.count = 1, .reusable = false}, REDUCE(sym__branch_check_terminal, 4),
  [106] = {.count = 1, .reusable = true}, REDUCE(sym__branch_check_terminal, 4),
  [108] = {.count = 1, .reusable = true}, REDUCE(sym_branch_check, 4),
  [110] = {.count = 1, .reusable = true}, SHIFT(41),
  [112] = {.count = 1, .reusable = true}, REDUCE(sym_styles, 3),
  [114] = {.count = 1, .reusable = true}, REDUCE(sym__style_list, 2),
  [116] = {.count = 1, .reusable = true}, SHIFT(44),
  [118] = {.count = 1, .reusable = true}, SHIFT(45),
  [120] = {.count = 1, .reusable = true}, REDUCE(sym_important_styles, 3),
  [122] = {.count = 1, .reusable = true}, REDUCE(sym__string_value, 1),
  [124] = {.count = 1, .reusable = true}, REDUCE(sym_style, 3),
  [126] = {.count = 1, .reusable = true}, REDUCE(sym__style_list, 3),
  [128] = {.count = 1, .reusable = true}, REDUCE(sym__boolean_value, 1),
  [130] = {.count = 1, .reusable = true}, REDUCE(sym__color_value, 1),
};
