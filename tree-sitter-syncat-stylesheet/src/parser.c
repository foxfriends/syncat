...
enum {
  ...
  sym__selectors = 36,
  sym_selector = 37,
  sym__terminal_selector = 38,
  sym__selector_scope = 39,
  sym__selector_node = 40,
  sym_direct_child = 41,
  sym_style = 42,
  sym_style_name = 43,
  sym_style_value = 44,
  sym__boolean_value = 45,
  sym__color_literal = 46,
  aux_sym_source_file_repeat1 = 47,
  aux_sym_rule_repeat1 = 48,
};
...
static uint16_t ts_parse_table[STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [11] = {
    [aux_sym_rule_repeat1] = STATE(16),
    [sym_style] = STATE(16),
    [sym_style_name] = STATE(17),
    [anon_sym_color] = ACTIONS(35),
    [anon_sym_underline] = ACTIONS(35),
    [anon_sym_reverse] = ACTIONS(35),
    [anon_sym_hidden] = ACTIONS(35),
    [sym_comment] = ACTIONS(3),
    [anon_sym_background_DASHcolour] = ACTIONS(35),
    [anon_sym_strikethrough] = ACTIONS(35),
    [anon_sym_italic] = ACTIONS(35),
    [anon_sym_blink] = ACTIONS(35),
    [anon_sym_RBRACE] = ACTIONS(37),
    [anon_sym_background_DASHcolor] = ACTIONS(35),
    [anon_sym_colour] = ACTIONS(35),
    [anon_sym_bold] = ACTIONS(35),
  ...
  [13] = {
    ...
    [sym_direct_child] = STATE(5),
    [aux_sym_source_file_repeat1] = STATE(13),
    [sym_node_kind] = ACTIONS(39),
    [ts_builtin_sym_end] = ACTIONS(42),
    [sym_comment] = ACTIONS(3),
    [sym_token] = ACTIONS(44),
  },
  [14] = {
    [sym_comment] = ACTIONS(3),
  ...
  [20] = {
    ...
    [anon_sym_underline] = ACTIONS(59),
    [anon_sym_reverse] = ACTIONS(59),
    [anon_sym_hidden] = ACTIONS(59),
    [sym_comment] = ACTIONS(3),
    [anon_sym_background_DASHcolour] = ACTIONS(59),
    [anon_sym_strikethrough] = ACTIONS(59),
    [anon_sym_italic] = ACTIONS(59),
    [anon_sym_RBRACE] = ACTIONS(62),
    [anon_sym_blink] = ACTIONS(59),
    [anon_sym_background_DASHcolor] = ACTIONS(59),
    [anon_sym_colour] = ACTIONS(59),
    [anon_sym_bold] = ACTIONS(59),
    [anon_sym_dim] = ACTIONS(59),
  },
  [21] = {
    [sym_style_value] = STATE(23),
    [sym__boolean_value] = STATE(22),
    [sym__color_literal] = STATE(22),
    [anon_sym_true] = ACTIONS(64),
    [anon_sym_purple] = ACTIONS(64),
    [sym__color_index] = ACTIONS(64),
    [sym_comment] = ACTIONS(3),
    [anon_sym_false] = ACTIONS(64),
    [anon_sym_yellow] = ACTIONS(64),
    [sym__rgb_color] = ACTIONS(64),
    [anon_sym_white] = ACTIONS(64),
    [anon_sym_red] = ACTIONS(64),
    [anon_sym_black] = ACTIONS(64),
    [anon_sym_green] = ACTIONS(64),
    [anon_sym_cyan] = ACTIONS(64),
    [anon_sym_blue] = ACTIONS(64),
  },
  [22] = {
    [sym_comment] = ACTIONS(3),
...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [11] = {.count = 1, .reusable = true}, REDUCE(sym__selector_node, 1),
  [13] = {.count = 1, .reusable = true}, SHIFT(8),
  [15] = {.count = 1, .reusable = true}, REDUCE(sym__terminal_selector, 1),
  [17] = {.count = 1, .reusable = true}, REDUCE(sym_selector, 1),
  ...
  [29] = {.count = 1, .reusable = true}, REDUCE(sym_direct_child, 2),
  [31] = {.count = 1, .reusable = true}, REDUCE(sym__selector_scope, 2),
  [33] = {.count = 1, .reusable = true}, REDUCE(sym_selector, 2),
  ...
  [44] = {.count = 2, .reusable = true}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(3),
  ...
  [57] = {.count = 1, .reusable = true}, REDUCE(sym_rule, 4),
  [59] = {.count = 2, .reusable = true}, REDUCE(aux_sym_rule_repeat1, 2), SHIFT_REPEAT(14),
  [62] = {.count = 1, .reusable = true}, REDUCE(aux_sym_rule_repeat1, 2),
  [64] = {.count = 1, .reusable = true}, SHIFT(22),
